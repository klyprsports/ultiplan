...
const serializePlay = (play: Play, uid: string) => {
  ...
  return {
    ...
    sequenceName: play.sequenceName?.trim() || null,
...
const hydratePlay = (data: Omit<Play, 'id'>, id: string): Play => ({
  ...
  sequenceName: data.sequenceName || undefined,
  sequenceOrder: typeof data.sequenceOrder === 'number' ? data.sequenceOrder : undefined,
